...
abstract struct Asset
  ...
  property test3 = Tm_optional(Int64).new
  property test4 = Tm_optional(Int64).new
  property test5 = Tm_optional(Int64).new
  property test6 = Tm_optional(Int64).new
...
abstract struct Asset02 < Asset
  ...
  property value2 = Tm_static_variant(UInt64, UInt8, Int64).new(199_i64)
...
# pp Pack(UInt64).unpack(177_u64.pack)
# pp Pack(Int64).unpack(333_i64.pack)
# pp Pack(UInt32).unpack(222_u32.pack)
# pp Pack(UInt8).unpack(1_u8.pack)
...
# # exit
# struct Asset
#   property amount : T_share_type
#   property asset_id : Tm_protocol_id_type(ObjectType::Asset)
